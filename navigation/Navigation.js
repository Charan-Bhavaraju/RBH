...
// export const IndividualContribution1 = ({navigation}) => <Screen navigation={navigation} screen='IndividualContribution1' />
// export const IndividualContribution2 = ({navigation}) => <Screen navigation={navigation} screen='IndividualContribution2' />
export const SearchDonor = ({navigation}) => <Screen navigation={navigation} screen='searchDonor' />
export const LeadDonor = ({navigation}) => <Screen navigation={navigation} screen='leadDonor' />