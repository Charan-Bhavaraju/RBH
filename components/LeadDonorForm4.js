...
//        this.setState({purposeofdonation: purposeofdonationdata})
    ...
    _submitContributionForm(values){
        ...
        return (
            <View style = {globalStyles.container}>
                ...
                onSubmit = {async (values, actions) => {
                    ...
                    if(this.props.navigation.state.params.donorDetails.fromSearchFlag === false) {
                        console.log("Creating Donor")
                        let result = this._submitAddDonorForm(values);
                        console.log(result);
                    }else {
                        this.setState({sponsorId: this.props.navigation.state.params.donorDetails.sponsorNo})
                    }
                    let res = this._submitContributionForm(values);
                    console.log(res);
